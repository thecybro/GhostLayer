 ...
 * @returns {string}
 */
export function encrypt(my_public_b64, my_private_b64, their_public_b64, message) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(my_public_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(my_private_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(their_public_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
